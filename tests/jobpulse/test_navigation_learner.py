...
# Removed 2026-05-03: test_redirect_loop_detected
# Required AsyncMock for orchestrator + driver + page + bridge (Category B —
# Playwright bridge mock). Loop-detection behavior is exercised end-to-end
# in tests/jobpulse/integration/test_pipeline_live.py against a real driver.
