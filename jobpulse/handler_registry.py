...
def _build_handler_map() -> dict[Intent, Callable[["ParsedCommand"], str]]:
    ...
    from jobpulse.dispatcher import (
        ...
        _handle_learning_status, _handle_learning_report,
        _handle_learning_pause, _handle_learning_resume,
        _handle_job_patterns, _handle_follow_ups, _handle_interview_prep,
        _handle_research,
        _handle_submit_draft, _handle_skip_draft, _handle_show_drafts,
        _handle_cancel,
    )
    ...
    return {
        ...
        Intent.LEARNING_STATUS: _handle_learning_status,
        Intent.LEARNING_REPORT: _handle_learning_report,
        Intent.LEARNING_PAUSE: _handle_learning_pause,
        Intent.LEARNING_RESUME: _handle_learning_resume,
        ...
        Intent.SUBMIT_DRAFT: _handle_submit_draft,
        Intent.SKIP_DRAFT: _handle_skip_draft,
        Intent.SHOW_DRAFTS: _handle_show_drafts,
