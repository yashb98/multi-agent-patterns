...
class DriverProtocol(Protocol):
    ...
    Return types use `Any` where implementations differ (e.g. FillResult vs dict).
    `screenshot()` returns raw PNG bytes from both drivers.
    """
    ...
    async def get_snapshot(self, **kwargs: Any) -> dict: ...
